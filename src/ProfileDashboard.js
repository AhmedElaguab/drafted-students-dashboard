...
function SectionLink({ active, to }) {
  return (
    <NavLink
      ...
      // Fix active links
      className={({ isActive }) =>
        active ? 'sideBarLink active' : 'sideBarLink'
      }
    >
      <svg
        width="28"
    ...
    <section className="resumeSection">
      ...
      <div className="resume">
        <div className="resumeInfo">
          <div className="resumeInfoHeader">
            <button className="resumeInfoHeaderInfo">
              <svg
                width="10"
                height="14"
                viewBox="0 0 10 14"
          ...
          <div className="resumeInfoContent">
            <p className="resumeInfoContentStep">2</p>
            <div className="resumeInfoContentInner">
              <h4 className="resumeInfoContentTitle">Tell us your story</h4>
              <p className="resumeInfoContentSubtitle">{title}</p>
            </div>
          </div>
          <div className="resumeInfoFooter">
            ...
            <a className="resumeInfoFooterBtn active" href="#">
              Record
            </a>
          </div>
        </div>
        <div className="resumeUpload">
          <div className="resumeUploadStatus">
            <h2 className="resumeUploadStatusTitle">In progress</h2>
            <p className="resumeUploadStatusSubtitle">Uploading your file</p>
          </div>
          <div className="resumeUploadFormWrapper">
            <form
              // onSubmit={handleFileUpload}
              className="resumeUploadForm"
              action="localhost:3000/upload"
              method="post"
              encType="multipart/form-data"
            >
              <div className="resumeUploadInfo">
                <div className="resumeUploadInfoIcon">
                  <svg
                    width="47"
                    height="64"
                    viewBox="0 0 47 64"
                ...
                <div className="resumeUploadInfoInner">
                  <p className="resumeUploadInfoTitle"> Your story.mp4</p>
                  <p className="resumeUploadInfoSize">536KB * 5 seconds left</p>
                </div>
                <div className="resumeUploadCancel">
                  <button className="resumeUploadCancelBtn">
                    <svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <p className="resumeUploadPercentage">38%</p>
                </div>
              </div>
              <div className="resumeUploadGauge">
...
const ProfileDashboard = ({
  ...
  const [resumeCount] = useState(3)
  const [resumeIndex] = useState(0)
        ...
        <main className="mainContent">
            ...
            <div className="profileInfo">
              ...
              <div className="profileInfoInner">
                <p className="profileInfoClass">
                  Class of {graduationYear}{' '}
                  <button className="profileInfoEdit">
                    <svg
                      width="15"
                      height="16"
                      viewBox="0 0 15 16"
                    ...
                    >
                      ...
                      />
                      <path
                        d="M12 6.5L8.5 3L0.5 11.5V14.5H4L12 6.5Z"
                        fill="#767675"
                      />
                    </svg>
                  </button>
                ...
                <a href="mailto:#" className="profileInfoEmail">
                  {email}
                </a>
              </div>
            </div>
            <div className="profileExper">
              <div className="profileExperEduc">
                ...
                <div className="profileExperContent">
                  ...
                  <p className="profileExperPara">Bachelor's degee, {major}</p>
                </div>
              </div>
              <div className="profileExperJobs">
                <div className="profileExperPicture" />
                <div className="profileExperContent">
                  <h4 className="profileExperTitle">Job Preferences</h4>
                  <p className="profileExperSubtitle">
                    Associate product manager
                  </p>
                  <p className="profileExperPara">Marketing</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="recently">
            ...
            <ul className="recentlyList">
              {[1, 2, 3, 4].map(item => {
                return (
                  <li key={item} className="recentlyListItem">
                    <div
                      className="recentlyListItemPicture"
                      style={{
                        backgroundImage:
                    ...
                    ></div>
                    <div>
                      <h4 className="recentlyListItemName">Assia McGuire</h4>
          ...
          {/* <ResumeRecord title="Tell us about your story?" /> */}
          <ResumeRecord title="What makes you stand out amongst other condidates?" />
          {/* <ResumeRecord title="Tell us about a time when you overcame a challenge?" /> */}
          {/* End Resume Section */}
        </main>
      </div>
    </>
